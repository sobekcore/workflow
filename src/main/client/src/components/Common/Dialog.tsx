  ...
  return (
    <Primitive.Root open={open}>
      <Primitive.Portal>
        ...
        <Primitive.Content className="fixed left-[50%] top-[50%] z-30 max-h-[90vh] w-[90vw] max-w-xl -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-3xl bg-white shadow-xl outline-none">
